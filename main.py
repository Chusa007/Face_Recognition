...
def FullRecognizedFace(qI):
    ...
    while True:
            ...
            for face_encoding in face_encodings:
                ...
                print('Name = {0}, был замечен на камере {1} в {2}'.format(str(name), str(window_name), str(datetime.datetime.now())))
...
FullRecognizedFace(queueImg)
print('12312')

# prc2 = multiprocessing.Process(target=FullRecognizedFace, args=(queueImg, ))
# prc2.start()
# print(prc2.pid)
